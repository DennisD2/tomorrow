/* $Header: sicl.h,v 1.231 98/02/19 16:43:06 hmgr Exp $ */
/* Copyright 1992-1993 Hewlett-Packard Company.  All Rights Reserved. */
/*
 * HP Standard Instrument Control Library
 *
 * This file conforms to the HP SICL Spec as specified in I_SICL_REVISION.
 *
 ...
 * Support levels:
 */
#define I_SICL_REVISION 39      /* HP SICL Revision 3.9 */
 ...
 */
#if defined(_MS_DOS_WIN) || defined(_SICL_WIN32) || defined(_SICL_LYNX_LE)
   /* Little Endian */
#define I_ORDER_LE
#undef  I_ORDER_BE
#endif

#if defined(_SICL_HPUX) || defined(_SICL_LYNX_BE)
   /* Big Endian */
#undef  I_ORDER_LE
#define I_ORDER_BE
#endif
