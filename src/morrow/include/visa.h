/*---------------------------------------------------------------------------*/
/* Distributed by Hewlett-Packard Company                                    */
/*                                                                           */
...
/* Title   : VISA.H                                                          */
/* Date    : 06-24-97                                                        */
/* Purpose : Include file for the VISA Library 1.1 specification with HP     */
/*           extensions.                                                     */
/*                                                                           */
/*---------------------------------------------------------------------------*/
...
#define VI_ATTR_GPIB_UNADDR_EN      (0x3FFF0184L)
...
#define VI_EVENT_VXI_VME_INTR       (0xBFFF2021L)
...
/*- Start of HPVISA Extensions Section ---------------------------------------*/

#if defined (HPVISA_ATTRIBUTES)
/*
  HPVISA specific attributes definitions.
*/
#endif /* HPVISA specific attributes */

#if defined (HPVISA_EXTENSIONS)
#pragma message ( "Note: HPVISA_EXTENSIONS have been enabled" )
/*
   No HP specific extensions defined here yet
*/
#endif /* HPVISA Extensions */

#if defined (HPVISA_NONINTEROP_EXTENSIONS)
#pragma message ( "Note: HPVISA_NONINTEROP_EXTENSIONS have been enabled" )
/*
   No NONINTEROP HP specific extensions defined here yet
*/
#endif /* HPVISA Non-interop Extensions */

/*- End of HPVISA Extensions Section -----------------------------------------*/
